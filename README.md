...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([42.38.1](https://github.com/renovatebot/renovate/releases/tag/42.38.1), 1 day ago) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.45.3](https://github.com/backstage/backstage/releases/tag/v1.45.3), 2 days ago) - Backstage is an open framework for building developer portals
...
- [envoyproxy/ai-gateway](https://github.com/envoyproxy/ai-gateway) ([v0.4.0](https://github.com/envoyproxy/ai-gateway/releases/tag/v0.4.0), 4 weeks ago) - Manages Unified Access to Generative AI Services built on Envoy Gateway

#### ⭐ Latest projects I've starred

- [metalbear-co/mirrord](https://github.com/metalbear-co/mirrord) 4762⭐
- [zensical/zensical](https://github.com/zensical/zensical) 1892⭐
- [changesets/changesets](https://github.com/changesets/changesets) 11066⭐
...
- [workadventure/workadventure](https://github.com/workadventure/workadventure) 5122⭐
- [basecamp/omarchy](https://github.com/basecamp/omarchy) 18050⭐
- [seluard/open-adr](https://github.com/seluard/open-adr) 7⭐
- [integrations/terraform-provider-github](https://github.com/integrations/terraform-provider-github) 1066⭐
- [github/spec-kit](https://github.com/github/spec-kit) 53638⭐
