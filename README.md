...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([41.148.6](https://github.com/renovatebot/renovate/releases/tag/41.148.6), 1 day ago) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.44.0](https://github.com/backstage/backstage/releases/tag/v1.44.0), 1 day ago) - Backstage is an open framework for building developer portals
- [k0sproject/k0sctl](https://github.com/k0sproject/k0sctl) ([v0.26.0](https://github.com/k0sproject/k0sctl/releases/tag/v0.26.0), 1 day ago) - A bootstrapping and management tool for k0s clusters.
...
- [errata-ai/vale](https://github.com/errata-ai/vale) 5018⭐
- [workadventure/workadventure](https://github.com/workadventure/workadventure) 5026⭐
- [basecamp/omarchy](https://github.com/basecamp/omarchy) 14097⭐
...
- [github/spec-kit](https://github.com/github/spec-kit) 35958⭐
- [JanDeDobbeleer/oh-my-posh](https://github.com/JanDeDobbeleer/oh-my-posh) 20317⭐
- [envoyproxy/ai-gateway](https://github.com/envoyproxy/ai-gateway) 1119⭐
- [shurcooL/githubv4](https://github.com/shurcooL/githubv4) 1166⭐
- [SchemaStore/schemastore](https://github.com/SchemaStore/schemastore) 3519⭐
