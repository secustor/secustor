...
- [prometheus/prometheus](https://github.com/prometheus/prometheus) ([v2.44.0-rc.0](https://github.com/prometheus/prometheus/releases/tag/v2.44.0-rc.0), 1 day ago) - The Prometheus monitoring system and time series database.
...
- [grafana/mimir](https://github.com/grafana/mimir) ([mimir-2.8.0-rc.2](https://github.com/grafana/mimir/releases/tag/mimir-2.8.0-rc.2), 1 day ago) - Grafana Mimir provides horizontally scalable, highly available, multi-tenant, long-term storage for Prometheus.
...
- [googleforgames/agones](https://github.com/googleforgames/agones) 5225⭐
- [lindell/multi-gitter](https://github.com/lindell/multi-gitter) 543⭐
- [google/osv-scanner](https://github.com/google/osv-scanner) 4761⭐
- [guitmz/n26](https://github.com/guitmz/n26) 142⭐
- [microsoft/LoRA](https://github.com/microsoft/LoRA) 3162⭐
- [abetlen/llama-cpp-python](https://github.com/abetlen/llama-cpp-python) 813⭐
- [pdm-project/pdm](https://github.com/pdm-project/pdm) 4406⭐
- [aquaproj/aqua](https://github.com/aquaproj/aqua) 309⭐
- [openrewrite/rewrite](https://github.com/openrewrite/rewrite) 1008⭐
- [ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp) 24759⭐
