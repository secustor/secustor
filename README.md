...
- [open-telemetry/opentelemetry-helm-charts](https://github.com/open-telemetry/opentelemetry-helm-charts) ([opentelemetry-collector-0.44.1](https://github.com/open-telemetry/opentelemetry-helm-charts/releases/tag/opentelemetry-collector-0.44.1), 3 days ago) - OpenTelemetry Helm Charts
- [grafana/helm-charts](https://github.com/grafana/helm-charts) ([grafana-agent-0.2.1](https://github.com/grafana/helm-charts/releases/tag/grafana-agent-0.2.1), 3 days ago)
- [runatlantis/atlantis](https://github.com/runatlantis/atlantis) ([v0.22.3-pre.20230111](https://github.com/runatlantis/atlantis/releases/tag/v0.22.3-pre.20230111), 3 days ago) - Terraform Pull Request Automation
- [open-telemetry/opentelemetry-js](https://github.com/open-telemetry/opentelemetry-js) ([api/v1.4.0](https://github.com/open-telemetry/opentelemetry-js/releases/tag/api/v1.4.0), 4 days ago) - OpenTelemetry JavaScript Client
- [open-telemetry/opentelemetry-collector-contrib](https://github.com/open-telemetry/opentelemetry-collector-contrib) ([v0.69.0](https://github.com/open-telemetry/opentelemetry-collector-contrib/releases/tag/v0.69.0), 6 days ago) - Contrib repository for the OpenTelemetry Collector
...
- [cilium/cilium](https://github.com/cilium/cilium) 14064⭐
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) 8217⭐
- [cert-manager/aws-privateca-issuer](https://github.com/cert-manager/aws-privateca-issuer) 119⭐
- [hashicorp/terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) 8110⭐
