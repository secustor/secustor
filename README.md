...
- [containerbase/base](https://github.com/containerbase/base) ([9.23.8](https://github.com/containerbase/base/releases/tag/9.23.8), 1 day ago) - The containerbase project&#39;s base image source
- [exoscale/terraform-provider-exoscale](https://github.com/exoscale/terraform-provider-exoscale) ([v0.53.1](https://github.com/exoscale/terraform-provider-exoscale/releases/tag/v0.53.1), 3 days ago) - Terraform Exoscale provider
- [cert-manager/aws-privateca-issuer](https://github.com/cert-manager/aws-privateca-issuer) ([v1.2.6](https://github.com/cert-manager/aws-privateca-issuer/releases/tag/v1.2.6), 6 days ago) - Addon for cert-manager that issues certificates using AWS ACM PCA.
...
- [Infisical/infisical](https://github.com/Infisical/infisical) 10040⭐
- [typst/typst](https://github.com/typst/typst) 21965⭐
- [opentofu/opentofu](https://github.com/opentofu/opentofu) 15313⭐
- [ossf/scorecard](https://github.com/ossf/scorecard) 3766⭐
...
- [bytecodealliance/javy](https://github.com/bytecodealliance/javy) 1607⭐
