...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([42.69.2](https://github.com/renovatebot/renovate/releases/tag/42.69.2), 1 day ago) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io
...
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.47.0-next.1](https://github.com/backstage/backstage/releases/tag/v1.47.0-next.1), 3 days ago) - Backstage is an open framework for building developer portals
...
- [metalbear-co/mirrord](https://github.com/metalbear-co/mirrord) 4809⭐
- [zensical/zensical](https://github.com/zensical/zensical) 2307⭐
- [changesets/changesets](https://github.com/changesets/changesets) 11205⭐
- [aws-samples/anthropic-on-aws](https://github.com/aws-samples/anthropic-on-aws) 258⭐
- [errata-ai/vale](https://github.com/errata-ai/vale) 5165⭐
- [workadventure/workadventure](https://github.com/workadventure/workadventure) 5151⭐
- [basecamp/omarchy](https://github.com/basecamp/omarchy) 18760⭐
...
- [github/spec-kit](https://github.com/github/spec-kit) 59002⭐
