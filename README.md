...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([42.29.4](https://github.com/renovatebot/renovate/releases/tag/42.29.4), 1 day ago) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.45.2](https://github.com/backstage/backstage/releases/tag/v1.45.2), 5 days ago) - Backstage is an open framework for building developer portals
- [secustor/backstage-plugins](https://github.com/secustor/backstage-plugins) ([@secustor/backstage-plugin-renovate-backend-module-runtime-docker@3.0.0](https://github.com/secustor/backstage-plugins/releases/tag/%40secustor/backstage-plugin-renovate-backend-module-runtime-docker%403.0.0), 6 days ago) - contains backstage plugins written and maintained by myself
...
- [metalbear-co/mirrord](https://github.com/metalbear-co/mirrord) 4754⭐
- [zensical/zensical](https://github.com/zensical/zensical) 1808⭐
- [changesets/changesets](https://github.com/changesets/changesets) 11048⭐
- [aws-samples/anthropic-on-aws](https://github.com/aws-samples/anthropic-on-aws) 241⭐
- [errata-ai/vale](https://github.com/errata-ai/vale) 5115⭐
- [workadventure/workadventure](https://github.com/workadventure/workadventure) 5111⭐
- [basecamp/omarchy](https://github.com/basecamp/omarchy) 17900⭐
...
- [github/spec-kit](https://github.com/github/spec-kit) 52504⭐
