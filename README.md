...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([42.30.2](https://github.com/renovatebot/renovate/releases/tag/42.30.2), 1 day ago) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.46.0-next.1](https://github.com/backstage/backstage/releases/tag/v1.46.0-next.1), 1 day ago) - Backstage is an open framework for building developer portals
...
- [metalbear-co/mirrord](https://github.com/metalbear-co/mirrord) 4756⭐
- [zensical/zensical](https://github.com/zensical/zensical) 1836⭐
- [changesets/changesets](https://github.com/changesets/changesets) 11053⭐
- [aws-samples/anthropic-on-aws](https://github.com/aws-samples/anthropic-on-aws) 243⭐
- [errata-ai/vale](https://github.com/errata-ai/vale) 5124⭐
- [workadventure/workadventure](https://github.com/workadventure/workadventure) 5111⭐
- [basecamp/omarchy](https://github.com/basecamp/omarchy) 17928⭐
...
- [github/spec-kit](https://github.com/github/spec-kit) 52818⭐
