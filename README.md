...
- [open-telemetry/opentelemetry-collector-contrib](https://github.com/open-telemetry/opentelemetry-collector-contrib) ([v0.75.0](https://github.com/open-telemetry/opentelemetry-collector-contrib/releases/tag/v0.75.0), 2 days ago) - Contrib repository for the OpenTelemetry Collector
...
- [nomic-ai/gpt4all](https://github.com/nomic-ai/gpt4all) 20274⭐
- [kubescape/kubescape](https://github.com/kubescape/kubescape) 8201⭐
- [helm-unittest/helm-unittest](https://github.com/helm-unittest/helm-unittest) 332⭐
- [grafana/pyroscope](https://github.com/grafana/pyroscope) 7553⭐
- [SigNoz/signoz](https://github.com/SigNoz/signoz) 12334⭐
- [defenseunicorns/zarf](https://github.com/defenseunicorns/zarf) 559⭐
- [cla-assistant/cla-assistant](https://github.com/cla-assistant/cla-assistant) 1129⭐
- [CtrlSpice/otel-desktop-viewer](https://github.com/CtrlSpice/otel-desktop-viewer) 94⭐
